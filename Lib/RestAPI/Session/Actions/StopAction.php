...
final class StopAction
{
    ...
    public static function main(array $data): PBXApiResult
    {
        ...
        return self::execute($main->requestStop(...));
    }

    /**
     * @param Closure(): RemoteSupportSession $requestStop
     */
    public static function execute(Closure $requestStop): PBXApiResult
    {
        try {
            $result = new PBXApiResult();
            $result->data = GetStatusAction::sessionData($requestStop());
            $result->success = true;
